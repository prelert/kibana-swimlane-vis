...
```
bin/kibana-plugin install https://github.com/prelert/kibana-swimlane-vis/releases/download/v5.6.9/prelert_swimlane_vis-5.6.9.zip
```

### Kibana 5.6.8:

```
bin/kibana-plugin install https://github.com/prelert/kibana-swimlane-vis/releases/download/v5.6.8/prelert_swimlane_vis-5.6.8.zip
```
